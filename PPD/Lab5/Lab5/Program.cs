...
namespace ppd_lab5
{
    ...
    public class Program
    {
        ...
        private static List<ManualResetEvent> connectDone = new List<ManualResetEvent>() { new ManualResetEvent(false) };
        private static List<ManualResetEvent> sendDone = new List<ManualResetEvent>() { new ManualResetEvent(false) };
        private static List<ManualResetEvent> receiveDone = new List<ManualResetEvent>() { new ManualResetEvent(false) };
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                //threads.Add(new Thread(() => { doStart(i); }));
